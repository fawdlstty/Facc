	...
	public class Op2ExprAST_1: IAST {
		...
		public IEnumerator<int> TryParse (int _pos) {
			...
			while (_1_0_enum.MoveNext ()) {
				yield return _1_0_enum.Current;
			}
		...
		IEnumerator<int> _try_parse_1_0 (int _pos) {
			Parser.ErrorPos = _pos;
			var _o = new Op2ExprAST_1_0 { Parser = Parser };
			var _enum = _o.TryParse (_pos);
			while (_enum.MoveNext ()) {
				Value_1_0 = _o;
				yield return _enum.Current;
		...
		public bool IsValid () => Value_1_0.IsValid ();
		...
		public int Length { get => Value_1_0.Length; }

		public Op2ExprAST_1_0 Value_1_0 { get; set; } = null;
	}

	public class Op2ExprAST_1_0: IAST {
		// [part of] op2_expr ::= (op2_sign expr)

		public AstParser Parser { init; get; }

		public IEnumerator<int> TryParse (int _pos) {
			if (!Parser.TryReg ("Op2ExprAST_1_0", _pos))
				yield break;
			var _1_0_0_enum = _try_parse_1_0_0 (_pos);
			while (_1_0_0_enum.MoveNext ()) {
				var _1_0_1_enum = _try_parse_1_0_1 (_1_0_0_enum.Current);
				while (_1_0_1_enum.MoveNext ()) {
					yield return _1_0_1_enum.Current;
				}
			}

			Parser.UnReg ("Op2ExprAST_1_0", _pos);
		}

		IEnumerator<int> _try_parse_1_0_0 (int _pos) {
			Parser.ErrorPos = _pos;
		...
		IEnumerator<int> _try_parse_1_0_1 (int _pos) {
			Parser.ErrorPos = _pos;
			var _o = new ExprAST { Parser = Parser };
			var _enum = _o.TryParse (_pos);
			while (_enum.MoveNext ()) {
		...
		public bool IsValid () => ((Value_1_0_0 != null && Value_1_0_0.IsValid ()) && (Value_1_0_1 != null && Value_1_0_1.IsValid ()));

		public void PrintTree (int _indent) {
			//Console.WriteLine ($"{new string (' ', _indent * 4)}Op2ExprAST_1_0");
			if (Value_1_0_0 != null && Value_1_0_0.IsValid ()) {
				Value_1_0_0.PrintTree (_indent + 1);
			}
			if (Value_1_0_1 != null && Value_1_0_1.IsValid ()) {
				Value_1_0_1.PrintTree (_indent + 1);
			}
		}

		public int Length { get => (Value_1_0_0 != null ? Value_1_0_0.Length : 0) + (Value_1_0_1 != null ? Value_1_0_1.Length : 0); }

		public Op2SignAST Value_1_0_0 { get; set; } = null;
		public ExprAST Value_1_0_1 { get; set; } = null;
	}
}
